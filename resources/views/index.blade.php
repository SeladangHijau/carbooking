                    ...
                    <div class="form-row card-body">
                        <div class="col-auto">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="point_a" aria-label="point_a" aria-describedby="basic-addon1">
                            </div>
                        </div>
                        <div class="col-auto">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="point_b" aria-label="point_b" aria-describedby="basic-addon1">
                            </div>
                        </div>
                        <div class="col-auto">
